...
const badgeCategories = [
  {
    ...
    badges: [
      ...
      },
      {
        ...
        earned: false,
        progress: 73,
        requirements: 'Solve 100 problems'
      },
      {
        id: 'legendary-coder',
  ...
  },
  {
    ...
    badges: [
      ...
      },
      {
        ...
        progress: 100,
        requirements: 'Complete 25 sessions'
      },
      {
        id: 'guru',
        name: 'Coding Guru',
        description: 'Achieved 4.8+ average rating as mentor',
        icon: '🏆',
        rarity: 'gold',
        earned: false,
        progress: 85,
        requirements: 'Maintain 4.8+ rating'
      }
    ]
  },
  {
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-200 mb-2">
                You're 27 problems away from earning the <span className="text-yellow-400">Algorithm Master</span> badge!
              </p>
