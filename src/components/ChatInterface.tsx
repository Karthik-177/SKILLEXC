...
const mockChats = [
  {
    ...
    lastMessage: 'The React hooks implementation looks great!',
    timestamp: '2:30 PM',
    unreadCount: 2,
    isOnline: true,
    isMentor: true
  },
  {
    ...
    lastMessage: 'Let me review your code and get back to you',
    timestamp: '1:15 PM',
    unreadCount: 0,
    isOnline: true,
    isMentor: true
  },
  {
    ...
    lastMessage: 'Alex: Anyone free for a coding session tonight?',
    timestamp: '11:45 AM',
    unreadCount: 5,
    isOnline: false,
    isGroup: true
  },
  {
    ...
    lastMessage: 'Thanks for the ML tutorial recommendation!',
    timestamp: 'Yesterday',
    unreadCount: 0,
    isOnline: false,
    isMentor: true
