...
const mockProfileData = {
  coverImage: "https://images.unsplash.com/photo-1753715613434-9c7cb58876b9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb2RpbmclMjB3b3Jrc3BhY2UlMjBtb2Rlcm4lMjBvZmZpY2V8ZW58MXx8fHwxNzU2MzA2MzQ2fDA&ixlib=rb-4.1.0&q=80&w=1080",
  bio: "Full-stack developer with 5+ years of experience in React, Node.js, and Python. Passionate about mentoring and helping others grow in their coding journey.",
  location: "San Francisco, CA",
  joinDate: "January 2022",
  skills: ["React", "TypeScript", "Node.js", "Python", "GraphQL", "AWS", "Docker", "MongoDB"],
  stats: {
    problemsSolved: 247,
    mentoringHours: 156,
    rating: 4.9,
  ...
  recentBadges: [
    { name: "Problem Solver", icon: "🏆", color: "from-yellow-400 to-orange-500" },
    { name: "Code Mentor", icon: "🎓", color: "from-blue-400 to-purple-500" },
    { name: "Speed Demon", icon: "⚡", color: "from-green-400 to-teal-500" },
    { name: "Team Player", icon: "🤝", color: "from-pink-400 to-red-500" }
  ]
};
